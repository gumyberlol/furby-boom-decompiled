...
namespace Relentless
{
	public class CameraSizeLimits : MonoBehaviour
	{
		...
		{
			// WIDESCREEN PATCH (disabled) -- original mobile letterboxing restored
			// to re-enable widescreen: remove the original logic below and uncomment the two lines above
